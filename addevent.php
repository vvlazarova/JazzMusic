...
Dynamic content page allowing the user to add events information on the website by sending data to the tables-->
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="add events from the admin panel">
                                    ...
                                    <li> <a href=""> <span class='bi bi-music-note' style='color: white'></span> Action</a>
                                        <ul class="dropdown">
                                                ...
                                                <li><a>News</a>
                                                    ...
                                                    <li><a><span class='bi bi-music-note' style='color:white'></span>Events</a>
                                                        <ul class="dropdown">
                                                            <li><a href="updateevent.php">Update</a></li>
                                                        <li><a href="addevent.php"><span class='bi bi-music-note' style='color:white'></span>Add</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="">Music</a>
                                                        <ul class="dropdown">
...
$page_link = 'login.html';
    ...
    $sql2 ="INSERT INTO gigs(day,date,band,venue,link,time) VALUES ('$_POST[day]','$_POST[date]','$_POST[band]', '$_POST[venue]','$_POST[link]','$_POST[time]')";
...
<div class="album-thumb"> 
    <h2>You have added a Event on " </i> ' . $date . '" Successfully</h2> 
    </div> 
    </div>
    </div>
    </div>
...
echo "<tbody>";
echo "<tr>";
echo "<td> <input type = 'text' name  = 'day' id= 'day' required /></td>";
echo "<td> <input type = 'date' name  = 'date' id= 'date' required /></td>";
...
echo '</select> </td>';
echo "<td> <input type = 'text' name  = 'venue' id= 'venue' required /></td>";
echo "<td> <input type = 'text' name  = 'link' id= 'link'/></td>";
echo "<td> <input type = 'time' name  = 'time' id= 'time'required /></td>";
echo "<td> <input type = 'submit' name= 'add' id= 'add' value= 'Add Event' /></td>";
echo "<tr>";
echo "</tbody>";
echo "</form>"; 
echo "</table>"; 
