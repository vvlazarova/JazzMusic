...
This page contents a script that allows a data to be added to the "mp3" database table. -->
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Add music database table">
                                    ...
                                    <ul class="dropdown">
                                                ...
                                                <li><a href="">News</a>
                                                    ...
                                                    <li><a href="">Music</a>
                                                        ...
                                                        <li><a href="addmp3.php"> <span class='bi bi-music-note' style='color: white'></span>Add</a></li>
                                                        </ul>
                                                    </li>
                                                </ul></li>
                                    <li><a href="#">Website</a>
...
//Show only if the user has logged in
...
//Insert the input into the table
    $sql2 ="INSERT INTO mp3(name,code,price,mp3) VALUES ('$_POST[name]','$_POST[code]','$_POST[price]','$mp3')";
...
<div class="album-thumb"> 
    <h4>You have added a new details with Name </i> "' . $name . '" Successfully</h4> 
    </div> 
    </div>
    </div>
    </div>
...
if (move_uploaded_file ($_FILES ['mp3'] ['tmp_name'],"audio/" . $_FILES ['mp3'] ['name']))
...
<div class="text-center wow fadeInUp" data-wow-delay="300ms">
<div class="album-thumb"> 
    <h2>The file was not uploaded!!! your file must be in an MP3 or MP4 format with a maximum size of 2,00 MB</h2> 
...
//Variable name for the table
    ...
    $result = mysqli_query ($connection, "Select * FROM mp3");
...
<thead>
 ...
 echo "<form action = 'addmp3.php' method='POST' enctype='multipart/form-data'>";

echo "<tbody>";
echo "<tr>";

echo "<td> <input type = 'text' name  = 'name' id= 'name' required /></td>";
echo "<td> <input type = 'text' name  = 'code' id= 'code' /></td>";
echo "<td> <input type = 'number' name  = 'price' id= 'price' /></td>";
echo "<td> <input type = 'file' accept=' audio/*' name  = 'mp3' id= 'mp3'  /></td>";
echo "<td> <input type = 'submit' name= 'add' id= 'add' value= 'Add File' /></td>";
echo "<tr>";
echo "</tbody>";
echo "</form>"; 
echo "</table>"; 
...
(min-device-width: 768px) and (max-device-width: 1024px)  {
    ...
    td:nth-of-type(4):before { content: "*MP3"; }
}
</style>
