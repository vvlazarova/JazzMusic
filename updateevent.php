...
Dynamic content page allowing the user to update or delete events on the website by sending the action to the tables-->
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="update events on the website">
                                        ...
                                        <ul class="dropdown">
                                                ...
                                                <li><a>News</a>
                                                    ...
                                                    <li><a><span class='bi bi-music-note' style='color: white'></span>Events</a>
                                                        <ul class="dropdown">
                                                            <li><a href="updateevent.php"><span class='bi bi-music-note' style='color: white'></span>Update</a></li>
...

{
        ...
        if(isset($_POST['update']))
        {
            ...
            $sql ="UPDATE gigs SET day='$_POST[day]',date ='$_POST[date]',band ='$_POST[band]',venue = '$_POST[venue]',link ='$_POST[link]',time ='$_POST[time]' WHERE id = '$_POST[hidden]' ";
	...
	<div class="text-center wow fadeInUp" data-wow-delay="300ms">
		<div class="album-thumb"> 
         <h4><i>You Have Updated Event On </i><b>' . $date .'</b></h4> 
         </div>
         </div>
         </div>
         </div> ';
        ...
        {
            $sql1 ="DELETE from gigs WHERE id = '$_POST[hidden]' ";
	...
	<div class="text-center wow fadeInUp" data-wow-delay="300ms">
		<div class="album-thumb"> 
         <h4 style="color:red;"><i>You Have Deleted Event On </i><b>' . $date .'</b></h4> 
         </div>
         </div>
         </div>
         </div> ';
        ...
        //Variable name for the table
            ...
            $result = mysqli_query ($connection, "Select * FROM gigs");
        ...
        {
          //Table
          echo "<form id='del' action = 'updateevent.php' method='POST' enctype='multipart/form-data' >";
          ...
          echo "<td> <input type = 'url' name  = 'link' value= '" . $row ['link'] . "' ></td>";
