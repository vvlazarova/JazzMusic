...
Dynamic content page allowing the user to update or delete mp3 on the website by sending the action to the tables-->
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Update or delete mp3">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <!-- Title -->
    <title>Update mp3</title>
                                ...
                                <ul>
                                    ...
                                    <ul class="dropdown">
                                                ...
                                                <li><a href="">News</a>
                                                    ...
                                                    <li><a href=""><span class='bi bi-music-note' style='color: white'></span>Music</a>
                                                        <ul class="dropdown">
                                                            <li><a href="updatemp3.php"><span class='bi bi-music-note' style='color: white'></span>Update</a></li>
...

{
        ...
        if(isset($_POST['update']))
        {
            ...
            $sql ="UPDATE mp3 SET name = '$_POST[name]',code ='$_POST[code]',price ='$_POST[price]',mp3 ='$_POST[mp3]' WHERE id = '$_POST[hidden]' ";
	...
	<div class="text-center wow fadeInUp" data-wow-delay="300ms">
		<div class="album-thumb"> 
         <h4><i>You Have Updated File With Name </i><b>"' . $name .'"</b></h4> 
         </div>
         </div>
         </div>
         </div> ';
        ...
        {
            $sql1 ="DELETE from mp3 WHERE id = '$_POST[hidden]' ";
	...
	<div class="text-center wow fadeInUp" data-wow-delay="300ms">
		<div class="album-thumb"> 
         <h4 style="color:red;"><i>You Have Deleted File With Name </i><b>' . $name .'</b></h4> 
         </div>
         </div>
         </div>
         </div> ';
        ...
        {
          //Table
          echo "<form id='del' action = 'updatemp3.php' method='POST' enctype='multipart/form-data' >";
          ...
          echo "<td> <input type = 'text' name  = 'mp3' value= '" . $row ['mp3'] . "' ></td>";
