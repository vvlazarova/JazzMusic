...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="update news on the website">
                                    ...
                                    <li> <a href=""> <span class='bi bi-music-note' style='color: white'></span> Action</a>
                                        <ul class="dropdown">
                                                ...
                                                <li><a><span class='bi bi-music-note' style='color: white'></span>News</a>
                                                    <ul class="dropdown">
                                                        <li><a href="updatenews.php"><span class='bi bi-music-note' style='color: white'></span>Update</a></li>
...

{
        ...
        if(isset($_POST['update']))
        {
            ...
            $sql ="UPDATE news SET p1 = '$_POST[p1]',p2 ='$_POST[p2]',iframe ='$_POST[iframe]' WHERE id = '$_POST[hidden]' ";
	...
	<div class="text-center wow fadeInUp" data-wow-delay="300ms">
		<div class="album-thumb"> 
         <h4><i>You Have Updated News </i><b>"' . $news .'"</b></h4> 
         </div>
         </div>
         </div>
         </div> ';
        ...
        {
            $sql1 ="DELETE from news WHERE id = '$_POST[hidden]' ";
	...
	<div class="text-center wow fadeInUp" data-wow-delay="300ms">
		<div class="album-thumb"> 
         <h4 style="color:red;"><i>You Have Deleted News </i><b>"' . $news .'"</b></h4> 
         </div>
         </div>
         </div>
         </div> ';
        ...
        {
          //Table
          echo "<form id='del' action = 'updatenews.php' method='POST' enctype='multipart/form-data' >";
