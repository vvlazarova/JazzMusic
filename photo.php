...
<!--Dynamic content photo gallery page-->
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Jazz music photo gallery">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="#"><span class='bi bi-music-note' style='color: white'></span>Gallery</a>
                                        ...
                                        <ul class="dropdown">
                                            <li><a href="photo.php"> <span class='bi bi-music-note' style='color: black'></span>Photo</a></li>
...
while($row = mysqli_fetch_array($result, MYSQLI_ASSOC))
 {
echo    '<div>';
echo "<a class='lightbox' href='img/gallery/". $row['img'] . "'target='_blank'>";
   echo "<img class='grid-item grid-item-9' src='img/gallery/". $row['img'] ." 'alt=''>";
   echo '</a>';
   echo '<p>'. $row['text'] . '</p>';
 echo '</div>';
 }
