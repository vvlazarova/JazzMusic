...
This page contents a script that allows a data to be updated/deleted to the "photo" database table. -->
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Update photos on the website">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <ul class="dropdown">
                                                <li><a href=""><span class='bi bi-music-note' style='color: white'></span>Photo</a>
                                                    <ul class="dropdown">
                                                        <li><a href="updatephoto.php"> <span class='bi bi-music-note' style='color: white'></span> Update</a></li>
...

{
        ...
        if(isset($_POST['update']))
        {
            ...
            $sql ="UPDATE photo SET img = '$_POST[img]',text ='$_POST[text]',band ='$_POST[band]',venue ='$_POST[venue]',date ='$_POST[date]' WHERE id = '$_POST[hidden]' ";
	...
	<div class="text-center wow fadeInUp" data-wow-delay="300ms">
		<div class="album-thumb"> 
         <h4><i>You Have Updated Photo With Name </i><b>' . $photo .'</b></h4> 
         </div>
         </div>
         </div>
         </div> ';
        ...
        {
            $sql1 ="DELETE from photo WHERE id = '$_POST[hidden]' ";
	...
	<div class="text-center wow fadeInUp" data-wow-delay="300ms">
		<div class="album-thumb"> 
         <h4 style="color:red;"><i>You Have Deleted Photo With Name </i><b>' . $photo .'</b></h4> 
         </div>
         </div>
         </div>
         </div> ';
        ...
        {
          //Table
          echo "<form id='del' action = 'updatephoto.php' method='POST' enctype='multipart/form-data' >";
