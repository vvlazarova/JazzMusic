...
This page contents a script that allows a data to be added to the "video" database table. -->
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="add video on the website ">
                                        ...
                                        <ul class="dropdown">
                                                ...
                                                <li><a ><span class='bi bi-music-note' style='color: white'></span>Video</a>
                                                    <ul class="dropdown">
                                                        ...
                                                        <li><a href="addvideo.php"> <span class='bi bi-music-note' style='color: white'></span>Add</a></li>
                                                    </ul>
                                                </li>
                                                <li><a >News</a>
                                                    <ul class="dropdown">
...
$page_link = 'login.html';
    ...
    $sql2 ="INSERT INTO video(iframe,band,name) VALUES ('$_POST[iframe]','$_POST[band]','$_POST[name]')";
...
<div class="album-thumb"> 
    <h2>You have added a new Video with Name </i> ' . $name . ' Successfully</h2> 
    </div> 
    </div>
    </div>
    </div>
...
<thead>
 ...
 echo "<form action = 'addvideo.php' method='POST' enctype='multipart/form-data'>";

echo "<tbody>";
echo "<tr>";

echo "<td> <input type = 'link' name  = 'iframe' id= 'iframe'  /></td>";
echo "<td> <select type = 'text' name  = 'band' id= 'band' />";
...
echo "<td> <input type = 'submit' name= 'add' id= 'add' value= 'Add New Video' /></td>";
echo "<tr>";
echo "</tbody>";
echo "</form>"; 
echo "</table>"; 
